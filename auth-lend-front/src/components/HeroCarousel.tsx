      ...
      >
        {slides.map((slide, idx) => (
          <div key={idx} className="relative w-full shrink-0 h-80 md:h-[32rem]">
            ...
            {/* desktop text */}
            <div className="hidden md:flex absolute inset-y-0 left-0 w-1/2 max-w-md flex-col justify-center gap-4 p-8 md:p-12">
            ...
            {/* mobile text */}
            <div className="md:hidden absolute inset-0 bg-black/50 flex flex-col justify-end p-4 gap-2 text-white">
